...
void Questioner::questionAboutIssue(const Issue &issue)
{
  const QMap<eIssue , IMessageBoxFn> messageBoxes {
    {eIssue::RecoveryKeyCorrupt,          &IMessageBox::questionYesNo},
    {eIssue::RecoveryKeyInstalled,        &IMessageBox::information},
    {eIssue::RecoveryKeyDownloadFailed,   &IMessageBox::questionYesNo}
  };
