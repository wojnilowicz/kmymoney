...
public:
  explicit MyMoneyStorageSql(const QSqlDatabase &db);
  ...
  *
   ...
   *
   */
   void setManager(MyMoneyFile *mgr);
   bool readFile(MyMoneyFile &storageManager);
  /**
   ...
   *
   */
  bool writeFile(const MyMoneyFile &storageManager);
